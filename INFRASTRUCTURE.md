...
- **GPU**: 1x NVIDIA RTX 4090 / T4 Tensor Core GPU (16GB VRAM) for YOLOv8 & PaddleOCR inference
- **RAM**: 32 GB DDR4
...
- **YOLO + PaddleOCR Pipeline**: ~2.5 GB VRAM allocated for model weight weights and frame batching.
