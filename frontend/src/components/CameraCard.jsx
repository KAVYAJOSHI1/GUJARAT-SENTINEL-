...
// Live camera preview card with status badge + metadata overlay
// (README §4.3). Real HLS / WebRTC playback is supplied by Rishit; until then
// this renders a simulated feed surface.
export default function CameraCard({ cam, selected, onClick }) {
        ...
        {isOffline ? (
          ...
          <div
            style={{
              position: "absolute",
              inset: 0,
              background: `linear-gradient(135deg, #071420 60%, ${isAlert ? "#200808" : "#081828"})`,
            }}
          >
            <div style={{ position: "absolute", bottom: 4, left: 6, color: C.feedMuted, fontSize: 9, fontFamily: "monospace" }}>
